import type { DrillScene, EntityState, Keyframe, PitchConfig, TacticPhase } from '../../../store'
...
//
// Actions are PRE-BOUND to their document, so the timeline never handles an id
