...
/**
 * A filename stem from a drill's name: lowercase, spaces and punctuation
 * collapsed to single hyphens, no leading/trailing hyphen. "4v2 Rondo
 * (wide)" becomes "4v2-rondo-wide". Falls back to `drill` so a drill named
 * entirely in punctuation still produces a usable file.
 */
