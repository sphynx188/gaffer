...
export const TACTIC_TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    anchor: 'timeline-bar',
    title: 'Keyframes',
    body: 'A tactic is a sequence, not a snapshot. Add a keyframe wherever the picture should change — the shape at the start, the shape after the press is broken.',
    placement: 'top',
  },
  {
    id: 'animate',
    anchor: 'timeline-bar',
    title: 'Watch it move',
    body: 'Press play and the players travel between your keyframes. Paths and trails show the routes they take, and phases let you name each passage of play.',
    placement: 'top',
  },
  {
    id: 'replay',
